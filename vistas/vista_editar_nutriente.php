		...
		<script src="../librerias/jquery-1.12.0.js"></script>
  		...
  		<script>
  			$(document).ready(function(){
				...
				$.post("../controladores/nutrientes/controlador_editar.php", { id_recibido: id_recibido }, function(data){
		...
		<div class="container">
			<section id="section-index">
				...
				<div class="row">
					...
					<input type='hidden' class='form-control' name='id_unidad' value="<?php echo $id_nutriente ?>" id="id_recibido">
