	...
	class Producto
		{
			...
			public function Leer()
			{
				$consulta=new MySQL1();
				$consulta->MySQL();
				$resultado=$consulta->consultar("SELECT p.id_producto, p.producto, p.presentacion, p.id_categoria, p.id_categoria, c.id_categoria, c.categoria FROM categoria AS c JOIN productos As p on p.id_categoria=c.id_categoria ORDER BY p.producto");
